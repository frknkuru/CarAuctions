...
export default function BidList({ user, auction }: Props) {
  ...
  if (loading) return <div><span>Loading bids...</span></div>
  return (
    <div className='rounded-lg shadow-md'>
      ...
      <div className='px-2 pb-2 text-gray-500'>
        ...
        ) : user && user.username === auction.seller ? (<div className='flex items-center justify-center p-2 text-lg font-semibold'>
